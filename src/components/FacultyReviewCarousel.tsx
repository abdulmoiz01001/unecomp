      ...
      <div className="w-full max-w-[1200px]">
        <div className="flex gap-4   overflow-x-auto snap-x snap-mandatory scrollbar-hide">
          {reviews.map((review, index) => (
            <div
              key={index}
              className="flex-shrink-0 mx-auto snap-center hover-effect cursor-pointer relative w-[300px] sm:w-[60%] md:w-[40%] lg:w-[30%] xl:w-[25%] h-[400px] md:h-[400px]"
            >
              <Image src={review.image} alt={`image-${index}`} className="w-full shad  h-full " />
